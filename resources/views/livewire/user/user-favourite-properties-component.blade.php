...
<section id="my-properties" class="my-properties properties-list">
    <div class="container">
        <div class="row">
            ...
            <!-- .col-md-4 -->
            <div class="col-xs-12 col-sm-7 col-md-8 ulp">
                <!-- .property-item #1 -->
                <div class="property-item">
                    <div class="property--img">
                        <a href="#">
                <img src="{{asset('assets/user/assets/images/properties/8.jpg')}}" alt="property image" class="img-responsive">
                ...
                <div class="property-item">
                    <div class="property--img">
                        <a href="#">
                <img src="{{asset('assets/user/assets/images/properties/9.jpg')}}" alt="property image" class="img-responsive">
                ...
                <div class="property-item">
                    <div class="property--img">
                        <a href="#">
                <img src="{{asset('assets/user/assets/images/properties/10.jpg')}}" alt="property image" class="img-responsive">
                <span class="property--status">For Sale</span>
                </a>
                    </div>
                    <div class="property--content">
                ...
                <div class="property-item">
                    <div class="property--img">
                        <a href="#">
                <img src="{{asset('assets/user/assets/images/properties/11.jpg')}}" alt="property image" class="img-responsive">
                <span class="property--status">For Rent</span>
                </a>
                    </div>
                    <div class="property--content">
