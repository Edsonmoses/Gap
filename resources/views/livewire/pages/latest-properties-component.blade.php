        ...
        <div class="carousel carousel-dots lp" data-slide="3" data-slide-rs="2" data-autoplay="true" data-nav="false" data-dots="true" data-space="25" data-loop="true" data-speed="800">
            ...
            <div class="property-item">
                <div class="property--img">
                    <a href="#">
            <img src="{{asset('assets/user/assets/images/properties/3.jpg')}}" alt="property image" class="img-responsive" width="364" height="364">
            ...
            <div class="property-item">
                <div class="property--img">
                    <a href="#">
            <img src="{{asset('assets/user/assets/images/properties/11.jpg')}}" alt="property image" class="img-responsive" width="364" height="364">
            <span class="property--status">For Sale</span>
            </a>
                </div>
                <div class="property--content">
            ...
            <div class="property-item">
                <div class="property--img">
                    <a href="#">
            <img src="{{asset('assets/user/assets/images/properties/5.jpg')}}" alt="property image" class="img-responsive" width="364" height="364">
            ...
            <div class="property-item">
                <div class="property--img">
                    <a href="#">
            <img src="{{asset('assets/user/assets/images/properties/4.jpg')}}" alt="property image" class="img-responsive" width="364" height="364">
            <span class="property--status">For Sale</span>
            </a>
                </div>
                <div class="property--content">
            ...
            <div class="property-item">
                <div class="property--img">
                    <a href="#">
            <img src="{{asset('assets/user/assets/images/properties/2.jpg')}}" alt="property image" class="img-responsive" width="364" height="364">
            <span class="property--status">For Rent</span>
</a>
                </div>
                <div class="property--content">
            ...
            <div class="property-item">
                <div class="property--img">
                    <a href="#">
            <img src="{{asset('assets/user/assets/images/properties/7.jpg')}}" alt="property image" class="img-responsive" width="364" height="364">
            <span class="property--status">For Sale</span>
</a>
                </div>
                <div class="property--content">
