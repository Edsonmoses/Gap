                                ...
                                <div class="card">
                                    <div class="card-body">
                                       ...
                                       <div class="button-list mb-2" style="float: right !important">
                                             <a href="/admin/steps" type="button" class="btn btn-outline-primary waves-effect waves-light">All Steps</a>
                                            <a href="/admin/add-steps" type="button" class="btn btn-outline-success waves-effect waves-light">Add Step</a>
                                        </div>
                                    ...
                                    <div class="form-box">
                                        ...
                                        <!-- .form-box end -->
                                        <input type="submit" value="Save Steps" name="submit" wire:click.prevent="storeSteps()" class="btn btn-info rounded-pill waves-effect waves-light">
                                </form>
                                        <!--end form-->
                                    </div> 
                                </div>
