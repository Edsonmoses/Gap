                                    ...
                                    <div class="card-body">
                                       ...
                                       <div class="button-list mb-2" style="float: right !important">
                                        ...
                                        <form class="mb-0" wire:ignore.self>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            @else
                                                            <img src="{{asset('/assets/user/assets/images/features/icons')}}/{{ $icon }}" width="120" />
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <!-- .col-md-4 end -->
                                            ...
                                            <!-- .form-box end -->
                                            <input type="submit" value="Save Update" name="submit" wire:click.prevent="storeProvide()" class="btn btn--primary">
                                        </form>
                                        <!--end form-->
                                    </div> 
                                </div>
