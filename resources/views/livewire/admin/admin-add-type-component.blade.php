                                ...
                                <div class="card">
                                    <div class="card-body">
                                       ...
                                       <div class="button-list mb-2" style="float: right !important">
                                             <a href="/admin/types" type="button" class="btn btn-outline-primary waves-effect waves-light">All Type</a>
                                        ...
                                        @endif
                                         <form class="mb-0" wire:ignore.self>
                                            ...
                                            <!-- .form-box end -->
                                            <button type="button" wire:click.prevent="storeType()" class="btn btn-info rounded-pill waves-effect waves-light">Save Category</button>
                                        </form>
                                        <!--end form-->
                                    </div> 
                                </div>
