                                ...
                                <div class="card">
                                    <div class="card-body">
                                       ...
                                       <div class="button-list mb-2" style="float: right !important">
                                             <a href="/admin/pages" type="button" class="btn btn-outline-primary waves-effect waves-light">All Pages</a>
                                            <a href="/admin/add-page" type="button" class="btn btn-outline-success waves-effect waves-light">Add Page</a>
                                        </div>
                                        ...
                                        <form class="mb-0" wire:ignore.self>
                                            ...
                                            <!-- .form-box end -->
                                            <input type="submit" value="Save Update" name="submit" wire:click.prevent="storePages()" class="btn btn-info rounded-pill waves-effect waves-light">
                                        </form>
                                        <!--end form-->
                                    </div> 
                                </div>
