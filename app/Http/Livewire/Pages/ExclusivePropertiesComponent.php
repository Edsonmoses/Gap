...
class ExclusivePropertiesComponent extends Component
{
    ...
    {
        $lproperties = Property::orderBy('created_at', 'desc')->latest()->where('exclusive', '=', 'exclusive')->paginate(6);
        ...
        $Featured = Property::orderBy('created_at', 'desc')->latest()->where('exclusive', '=', 'exclusive')->inRandomOrder()->paginate(6);
